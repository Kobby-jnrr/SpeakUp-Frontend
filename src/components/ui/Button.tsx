...
export function Button({ variant = 'primary', className = '', children, ...props }: ButtonProps) {
  const variants = {
    primary: 'bg-institution-700 text-white hover:bg-institution-900 focus:ring-institution-600',
    secondary: 'border border-slate-300 bg-white text-slate-800 hover:bg-slate-50 focus:ring-institution-600',
